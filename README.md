...
NEXT_PUBLIC_SANITY_PROJECT_ID= both same
SANITY_STUDIO_PROJECT_ID=both same

NEXT_PUBLIC_SANITY_DATASET=production
SANITY_REVALIDATE_SECRET=

RESEND_API_KEY=re_X8RXuajo_PPNWP5WQqbezY8WCkNu1DrG7
...
sanity dataset import lib/sanity/data/production.tar.gz production

sanity dataset import lib/sanity/data/production.tar.gz production --replace

if need change the node version

pnpm i --lockfile-only

export const revalidate = 60;

remove the comment of this
